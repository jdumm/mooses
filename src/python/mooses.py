...
def räkna_älgarna(cframe, draw_roi=False):
    ...
    cv2.rectangle(cframe, (x1-2,y1-2), (x2+1,y2+1), (255,255,0), 2)
    ...
    h,w,_ = roi.shape
    cv2.putText(cframe, "--> ", (280,873), font, 0.6, (255,255,0), 2, cv2.LINE_AA)
    cv2.putText(cframe, str(num_mooses), (330,885), font, 1.8, (255,255,0), 2, cv2.LINE_AA)
    if draw_roi:
